...
inline Dialog_Result fl_message_box(const std::string& message, const std::string& title, Message_Box_Buttons buttons, Message_Box_Icon icon) {
  ...
  static auto box_Types = map<Message_Box_Icon, Fl_Boxtype> {{Message_Box_Icon::None, FL_NO_BOX}, {Message_Box_Icon::Hand, FL_ROUND_UP_BOX}, {Message_Box_Icon::Question, FL_ROUND_UP_BOX}, {Message_Box_Icon::Exclamation, FL_DIAMOND_UP_BOX}, {Message_Box_Icon::Asterisk, FL_ROUND_UP_BOX}};
  static auto colors = map<Message_Box_Icon, Fl_Color> {{Message_Box_Icon::None, fl_rgb_color(255, 255, 255)}, {Message_Box_Icon::Hand, fl_rgb_color(255, 0, 0)}, {Message_Box_Icon::Question, fl_rgb_color(0, 0, 255)}, {Message_Box_Icon::Exclamation, fl_rgb_color(255, 255, 0)}, {Message_Box_Icon::Asterisk, fl_rgb_color(0, 0, 255)}};
  static auto label_Colors = map<Message_Box_Icon, Fl_Color> {{Message_Box_Icon::None, fl_rgb_color(0, 0, 255)}, {Message_Box_Icon::Hand, fl_rgb_color(255, 255, 255)}, {Message_Box_Icon::Question, fl_rgb_color(255, 255, 255)}, {Message_Box_Icon::Exclamation, fl_rgb_color(0, 0, 0)}, {Message_Box_Icon::Asterisk, fl_rgb_color(255, 255, 255)}};
  static auto labels = map<Message_Box_Icon, string> {{Message_Box_Icon::None, ""}, {Message_Box_Icon::Hand, "X"}, {Message_Box_Icon::Question, "?"}, {Message_Box_Icon::Exclamation, "!"}, {Message_Box_Icon::Asterisk, "i"}};
  static auto message_Box_Buttons_Texts = map<Message_Box_Buttons, array<const char*, 3>> {{Message_Box_Buttons::Ok, {nullptr, "&OK", nullptr}}, {Message_Box_Buttons::Ok_Cancel, {"&Cancel", "&OK", nullptr}}, {Message_Box_Buttons::Abort_Retry_Ignore, {"&Abort", "&Retry", "&Ignore"}}, {Message_Box_Buttons::Yes_No_Cancel, {"&Cancel", "&Yes", "&No"}}, {Message_Box_Buttons::Yes_No, {"&No", "&Yes", nullptr}}, {Message_Box_Buttons::Retry_Cancel, {"&Cancel", "&Retry", nullptr}}};
  static auto message_Box_Buttons_Results = map<Message_Box_Buttons, array<Dialog_Result, 3>> {{Message_Box_Buttons::Ok, {Dialog_Result::Ok, Dialog_Result::Ok, Dialog_Result::Ok}}, {Message_Box_Buttons::Ok_Cancel, {Dialog_Result::Cancel, Dialog_Result::Ok, Dialog_Result::None}}, {Message_Box_Buttons::Abort_Retry_Ignore, {Dialog_Result::Abort, Dialog_Result::Retry, Dialog_Result::Ignore}}, {Message_Box_Buttons::Yes_No_Cancel, {Dialog_Result::Cancel, Dialog_Result::Yes, Dialog_Result::No}}, {Message_Box_Buttons::Yes_No, {Dialog_Result::No, Dialog_Result::Yes, Dialog_Result::None}}, {Message_Box_Buttons::Retry_Cancel, {Dialog_Result::Cancel, Dialog_Result::Retry, Dialog_Result::No}}};
