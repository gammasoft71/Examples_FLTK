...
namespace Examples {
  ...
  private:
    static void on_menu_item_click(Fl_Widget* sender, void* window) {reinterpret_cast<Main_Window*>(window)->on_menu_item_click(dynamic_cast<Fl_Menu_Bar&>(*sender));}
    void on_menu_item_click(Fl_Menu_Bar& menu) {
