  ...
  public:
    Main_Window() : Fl_Window(200, 100, 420, 350, "Box and unicode text example") {
      ...
      for (auto index = 0U; index < languages.size(); ++index) {
        ...
        items[index].first->align(FL_ALIGN_LEFT | FL_ALIGN_INSIDE | FL_ALIGN_CLIP | FL_ALIGN_WRAP);
        ...
        items[index].second->align(FL_ALIGN_LEFT | FL_ALIGN_INSIDE | FL_ALIGN_CLIP | FL_ALIGN_WRAP);
