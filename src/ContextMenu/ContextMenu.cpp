...
namespace Examples {
  ...
  public:
    Main_Window() : Fl_Window(200, 100, 300, 300, "ContextMenu example") {
  ...
  private:
    static void OnMenuItemClick(Fl_Widget* sender, void* window) {reinterpret_cast<Main_Window*>(window)->OnMenuItemClick(dynamic_cast<Fl_Menu_Button&>(*sender));}
